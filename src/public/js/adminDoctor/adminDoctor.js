      ...
      data.Doctores.forEach((doctor) => {
        ...
        <div class="wrapper">
          ...
          <div class="doctor-info">
            ...
            <p><strong>Precio de la Cita:</strong> ${doctor.ticket_price || "N/A"
          }</p>
            <p><strong>Especialización:</strong> ${doctor.specialization || "N/A"
          }</p>
            ...
            <p><strong>Estado:</strong> <span class="doctor-status">${doctor.isApproved
          }</span></p>
            <div class="btn-doctor">
              <button class="approveDoctor" data-id="${doctor._id
          }">Aprobar</button>
              <button class="cancelDoctor" data-id="${doctor._id
          }">Cancelar</button>
              <button class="deleteDoctor" data-id="${doctor._id
          }">Eliminar</button>
            </div>
          </div>
        </div>
